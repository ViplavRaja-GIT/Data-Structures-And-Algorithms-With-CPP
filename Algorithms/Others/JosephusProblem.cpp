...
fixed direction. In each step, a certain number of people are skipped and
...
until only the last person remains, who is given freedom. Given the total
number of persons n and a number k which indicates that k-1 persons are
...
int main()
{
    ...
    cin >> n;
    cout << "Enter skipped kth." << endl;
    cin >> k;
    cout << "Place for last execution is " << josephus(n, k) << endl;
    return 0;
}